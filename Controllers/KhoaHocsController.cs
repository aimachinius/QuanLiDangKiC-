...
namespace QuanLiDangKiCSharp.Controllers
{
    public class KhoaHocsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKhoaHoc,TenKhoaHoc,GiangVien,ThoiGianKhaiGiang,HocPhi,SoLuongHocVienToiDa")] KhoaHoc khoaHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKhoaHoc,TenKhoaHoc,GiangVien,ThoiGianKhaiGiang,HocPhi,SoLuongHocVienToiDa")] KhoaHoc khoaHoc)
        {
            if (ModelState.IsValid)
            {
